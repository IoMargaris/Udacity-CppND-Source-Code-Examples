 ...
 * @create date 25 Aug. 2020 - 16:55:06

 * @desc [In its simplest form, using a mutex consists of four straight-forward steps
 ...
 * a mutex has been added to the class as a private data member. In the pushBack function, the mutex is locked before 
 ...
 * to the vector and a simultaneous write access (even when under the lock) would occur. 
 ...
 * By using a mutex to our shared resource, a data race has been effectively avoided
